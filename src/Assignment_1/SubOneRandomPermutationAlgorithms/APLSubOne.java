...
public class APLSubOne {
    ...
    public void run() {
        PermutationAlgorithms permutationAlgorithms = new PermutationAlgorithms(AMOUNT_OF_NUMBERS);
        ...
        switch (ALGORITHM_TO_RUN) {
            case 1:
                for (int i = 1; i <= NUMBER_OF_ALGORITHM_RUNS; i++) {
                    System.out.println("Sub-Assignment 1.1 - Run #" + i);

                    long startTime = System.currentTimeMillis();
                    System.out.println("Randomly generated permuted array: " + Arrays.toString(permutationAlgorithms.algorithmOne(CHECK_ARRAY_IS_PERMUTED)));
